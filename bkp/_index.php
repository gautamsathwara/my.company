                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-4 col-md-9">
                                <div class="hero__img d-none d-lg-block pl-10" data-animation="fadeInRight" data-delay="1s">
                                    <img src="assets/img/hero/hero_bottom.png" alt="My Company App First Step Page">
                                </div>
                            </div>
                            <div class="col-lg-8">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-col-md-7">
                        <div class="app-active owl-carousel">
                            <div class="single-cases-img">
                                <img src="assets/img/gallery/App1.png" alt="Screenshot1">
                            </div>
                            <div class="single-cases-img">
                                <img src="assets/img/gallery/App2.png" alt="Screenshot2">
                            </div>
                            <div class="single-cases-img">
                                <img src="assets/img/gallery/App4.png" alt="Screenshot4">
                            </div>
                            <div class="single-cases-img">
                                <img src="assets/img/gallery/App5.png" alt="Screenshot5">
                            </div>
                            <div class="single-cases-img">
                                <img src="assets/img/gallery/App6.png" alt="Screenshot5">
                            </div>
                            <div class="single-cases-img">
                                <img src="assets/img/gallery/App7.png" alt="Screenshot5">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="app-img">
                            <img src="assets/img/shape/available-app-1.png" alt="My Company App Available">
                        </div>
                    </div>
                </div>
            </div>
