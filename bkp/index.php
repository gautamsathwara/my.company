...
<body>
    ...
    <main>
        <div class="slider-area" data-scroll-index="0">
            <div class="slider-active">
                <div class="single-slider slider-height slider-padding sky-blue d-flex align-items-center">
                    <div class="container">
                        <div class="row d-flex align-items-center mobile-margin visible-xs">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-col-md-7">
                        <div class="app-active owl-carousel">
                            ...
                            <div class="single-cases-img">
                                <img src="assets/img/ss/App3.png" alt="Screenshot4">
                            </div>
                            <div class="single-cases-img">
        ...
        <div id="accordion" class="container" style="margin-top: 5%;">
...
<!-- ACCORDION -->
<section id="site-accordion" class="site-accordion section-grey left-heading main-bg">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="accordian-main">
                    <h1 class="text-center mr-bt-10"> Our Offices</h1>
                    <!-- accordion -->
                    <div class="pricing-card-area mr-bt-10">
...
$.ajax({
        type: "GET",
        url: "https://master.my-company.app/apAdmin/controller/addressController.php",
        dataType: 'json',
        cache: false,
    ...
    for(var ii=0; ii<data.length; ii++){
            ...
            // var address = data[ii]['address'];
            //     html += '<div class="col-md-4 mb-3">';
            //     html += '<div class="card border border-info">';
            //     html += '<div class="card-header min-h-120 flex justify-content-center bg-transparent border-info ">';
            //     html += '<h5><img class="addressIMG" src="assets/img/logo/address.png" height=20 width=20>'+data[ii]['title']+'</h5>';
            //     html += '<h6 class="text-info">'+address+'</h6>';
            //     html += '<h6 class="text-info left5"><strong>Mobile : </strong>'+data[ii]['mobile1']+' </h6>';
            //     html += '<h6 class="text-info left5"><strong>Email : </strong>'+data[ii]['email1']+' </h6>';
            //     html += '</div>';
            //     html += '</div>';
            //     html += '</div>';

html += '<div class="col-xl-4 col-lg-4 col-md-6">';
html +=    '<div class="single-card text-center mb-30 bg-c">';
html +=        '<div class="card-top display: list-item;">';
html +=        '<span>'+data[ii]['title']+'</span>';
html +=        '</div>';
html +=        '<div class="card-bottom">';
html +=            '<ul>';
html +=                '<li class="text-center">'+data[ii]['address']+'</li>';
if (data[ii]['mobile1'] == '' || data[ii]['mobile1'] == null) {}else{
    html +=                '<li><i class="fa fa-phone fa-rotate-90" aria-hidden="true" title="Mobile"></i> '+data[ii]['mobile1']+'</li>';
}
if (data[ii]['mobile2'] == '' || data[ii]['mobile2'] == null) {}else{
    html +=                '<li><i class="fa fa-phone fa-rotate-90" aria-hidden="true" title="Mobile"></i> '+data[ii]['mobile2']+'</li>';
}

if (data[ii]['email1'] == '' || data[ii]['email1'] == null) {}else{
    html +=                '<li><i class="ti-email" aria-hidden="true" title="Email"></i> '+data[ii]['email1']+' </li>';
}

if (data[ii]['email2'] == '' || data[ii]['email2'] == null) {}else{
    html +=                '<li><i class="ti-email" aria-hidden="true" title="Email"></i> '+data[ii]['email2']+' </li>';
}
