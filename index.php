...
var myKeyVals = { getOfficeDetailsAll : 'getOfficeDetailsAll'};


$.ajax({
        type: "POST",
        url: "https://www.chplgroup.org/apAdmin/controller/officeController.php",
        data: myKeyVals,
        dataType: 'json',
        cache: false,
...
html +=        '<span>'+data[ii]['office_type']+'</span>';
html +=        '</div>';
html +=        '<div class="card-bottom">';
html +=            '<ul>';
html +=                '<li class="text-center">'+data[ii]['office_address']+'</li>';
if (data[ii]['office_contact_one'] == '' || data[ii]['office_contact_one'] == null || data[ii]['office_contact_one'] == '0') {}else{
    html +=                '<li><i class="fa fa-phone fa-rotate-90" aria-hidden="true" title="Mobile"></i> +' +data[ii]['country_code_one']+' '+data[ii]['office_contact_one']+'</li>';
}
if (data[ii]['office_contact_two'] == '' || data[ii]['office_contact_two'] == null || data[ii]['office_contact_two'] == '0') {}else{
    html +=                '<li><i class="fa fa-phone fa-rotate-90" aria-hidden="true" title="Mobile"></i> +' +data[ii]['country_code_two']+'  '+data[ii]['office_contact_two']+'</li>';
}

if (data[ii]['office_email_one'] == '' || data[ii]['office_email_one'] == null) {}else{
    html +=                '<li><i class="ti-email" aria-hidden="true" title="Email"></i> '+data[ii]['office_email_one']+' </li>';
}

if (data[ii]['office_email_two'] == '' || data[ii]['office_email_two'] == null) {}else{
    html +=                '<li><i class="ti-email" aria-hidden="true" title="Email"></i> '+data[ii]['office_email_two']+' </li>';
}
